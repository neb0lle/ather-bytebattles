...
;********************************************************************************************************
    ...
    .def   OS_CPU_GetST1
    .def   OSStartHighRdy
    .def   OS_CPU_RTOSINT_Handler
    .def   OS_CPU_INT_Handler
...
;********************************************************************************************************
    ...
    .ref   OSTCBCurPtr                                         ; Declared as OS_TCB * , 32-bit long
    .ref   OSTCBHighRdyPtr                                     ; Declared as OS_TCB * , 32-bit long
    .ref   OSPrioCur                                           ; Declared as INT8U    , 16-bit long
    .ref   OSPrioHighRdy                                       ; Declared as INT8U    , 16-bit long
    .ref   OSTaskSwHook
    .ref   OS_CPU_IntHandler
...
OSStartHighRdy:
    ...
    LCR     #OSTaskSwHook
                                                                ; Restore context.
    MOVL    XAR0, #OSTCBCurPtr                                 ; Get the process's SP.
    MOVL    XAR1, *XAR0
    MOV     AL  , *AR1
    MOV    @SP  ,  AL
                                                                ; Restore registers.
...
OS_CPU_RTOSINT_Handler:
    ...
    MOVL    XAR0, #OSPrioHighRdy
    MOVL    XAR1, #OSPrioCur
    MOV     ACC, *XAR0
    MOV     *XAR1, ACC
                                                                ; OSTCBCurPtr = OSTCBHighRdyPtr
    MOVL    XAR0, #OSTCBHighRdyPtr
    MOVL    XAR1, #OSTCBCurPtr
    MOVL    ACC, *XAR0
    MOVL    *XAR1, ACC
