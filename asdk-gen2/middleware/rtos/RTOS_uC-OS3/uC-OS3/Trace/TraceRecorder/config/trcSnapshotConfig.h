...
#define TRC_CFG_NFLAG			5
#define TRC_CFG_NMEM			5
#define TRC_CFG_NTASK_SEM        TRC_CFG_NTASK
#define TRC_CFG_NTASK_Q          TRC_CFG_NTASK
...
#define TRC_CFG_NAME_LEN_FLAG           32
#define TRC_CFG_NAME_LEN_MEM            32
#define TRC_CFG_NAME_LEN_TASK_SEM       32
#define TRC_CFG_NAME_LEN_TASK_Q         32
