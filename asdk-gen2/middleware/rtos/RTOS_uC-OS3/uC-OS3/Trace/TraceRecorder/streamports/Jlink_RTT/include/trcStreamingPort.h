 ...
 ******************************************************************************/
#define TRC_CFG_RTT_BUFFER_SIZE_UP 2500
...
#define TRC_RTT_ALLOC_UP() char _TzTraceData[TRC_CFG_RTT_BUFFER_SIZE_UP] TRC_CFG_RECORDER_DATA_ATTRIBUTE;    /* Static allocation */
#define TRC_STREAM_PORT_MALLOC() /* Static allocation. Not used. */
#endif
